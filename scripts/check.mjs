...
const root=process.cwd(),files=['index.html','src/app.js','src/poems.js','src/terms.js','src/review.js','src/games.js','src/storage.js','src/styles.css','src/rewards.css','src/corrections.css','src/reading.css','public/manifest.webmanifest','public/sw.js'];let bad=[];
